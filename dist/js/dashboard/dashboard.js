(function (factory) {
    typeof define === 'function' && define.amd ? define('dashboard', factory) :
    factory();
}((function () { 'use strict';
    ...
    class MessagesView {
      ...
      _generate__users_list() {
        ...
        Object.entries(json).forEach(([key, value]) => {
          let li = document.createElement('li'); // 0 = name
          // 1 = time
          // 2 = message

          li.innerText = Array.from(Object.values(value))[0]; // length = 3
