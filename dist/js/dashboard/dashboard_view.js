(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('dashboardView', ['exports'], factory) :
    (global = global || self, factory(global.dashboardView = {}));
    ...
    class Request {
      ...
      get_users() {
        // return new FetchTemplate().request('https://geekhub-frontend-js-9.herokuapp.com/api/users/all',TYPES.get)
        return fetch('https://geekhub-frontend-js-9.herokuapp.com/api/users/all', {
          method: TYPES.get,
          headers: {
    ...
    class MessagesView {
      ...
      _generate__messages_list() {
        ...
        let list_wrapper = document.createElement('ul'); // Now any user not create thread => messages. If use e.target.id => empty array
        ...
        document.body.addEventListener('click', e => {
          if (e.target.tagName.toLowerCase() == 'li' && e.target.id.length > 8) {
            ...
            this.messages_list.appendChild(list_wrapper); // }, 100)
          }
        });
    ...
    exports.UniversalTemplates = UniversalTemplates;
